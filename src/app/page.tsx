...
const dummyPosts: Post[] = [
  { id: 1, status: "現職", job: "プロコーチ／キャリアコンサルタント", industry: "コーチング", yearsOfExperience: 5, nickname: "望月 彩恵", age: "39歳", gender: "女性", comment: "コーチとして独立して5年。コーチングスクール講師業や企業研修支援など、法人／個人問わず、日々色々な方の目標達成支援を行っております。", imageUrl: "https://altosaex.sakura.ne.jp/jobimg/MochizukiSae.png", sessionVideo: "ON", preferredSessionTime: "都度相談" },
  ...
  { id: 3, status: "現職", job: "クライアントゲームプログラマー", industry: "ゲーム", yearsOfExperience: 13, nickname: "三原 広貴", age: "33歳", gender: "男性", comment: "Unityを使ったゲーム制作を13年ほど行っております。どのセクションにおいても設計をこなせ、即座にゲームを完成させることが得意です。", imageUrl: "https://altosaex.sakura.ne.jp/jobimg/MiharaHiroki.jpeg", sessionVideo: "ON" , preferredSessionTime: "平日夜間希望" },
	...
	{ id: 20, status: "現職", job: "セールスエンジニア", industry: "建設業の経営支援", yearsOfExperience: 1, nickname: "今井 秀哉", age: "27歳", gender: "男性", comment: "建設業を対象に経営支援事業とsaas事業をしています。\n経営支援事業は、採用・DX支援をしています。\nsaas事業は、デザインと開発をしています。\n以下経歴です。\n・ファーストリテーリング（アパレル）で2年店員\n・シェルフィー（建設IT）で2年営業", imageUrl: "https://altosaex.sakura.ne.jp/jobimg/man.png", sessionVideo: "ON", preferredSessionTime: "都度相談" },
	{ id: 21, status: "現職", job: "マーケティング", industry: "就転職支援系業界", yearsOfExperience: 3, nickname: "稲川", age: "30代", gender: "男性", comment: "求人広告・採用サイト・就活記事サイトなどの企業を転々としてきました。今の時代、キャリアポートフォリオのバランスを保つことがとても重要だと考えています。", imageUrl: "https://altosaex.sakura.ne.jp/jobimg/InagawaRyouwa.jpg", sessionVideo: "ON", preferredSessionTime: "都度相談" },
	{ id: 22, status: "現職", job: "広告、イベントキャスティングディレクター", industry: "芸能", yearsOfExperience: 11, nickname: "たつや", age: "41歳", gender: "男性", comment: "20代は商社の営業マン。\n30歳から芸能界の仕事につきました。\n企業PR（広告、イベント、映像）のタレントブッキングを行っています。\n自分の関心のある仕事につくことで120％のちからが発揮できることを実感しています。\n一人でも多くの子供が素敵な仕事と出会えますように。", imageUrl: "https://altosaex.sakura.ne.jp/jobimg/MochizukiTatsuya.jpg", sessionVideo: "ON", preferredSessionTime: "都度相談" },
	{ id: 23, status: "現職", job: "職業相談員", industry: "受給機関", yearsOfExperience: 4, nickname: "ヤッシー", age: "60代", gender: "男性", comment: "製造業で34年勤務\n早期退職制度にて退職\n職業相談と紹介、応募書類添削、模擬面接等\nカウンセラーとしてのスキルを活かし、相談者に寄り添い、一人ひとりの希望が叶うよう支援しています。", imageUrl: "https://altosaex.sakura.ne.jp/jobimg/man.png", sessionVideo: "ON", preferredSessionTime: "都度相談" },
	{ id: 24, status: "前職", job: "製造業", industry: "電気機器", yearsOfExperience: 34, nickname: "ヤッシー", age: "60代", gender: "男性", comment: "組立、部品入出庫、輸出管理、生産管理システム立ち上げ、全社決算・棚卸管理、品質管理・ISO導入、内部統制導入・業務の有効性及び効率性、財務報告の信頼性、事業活動に関 わる法令等の遵守並びに資産の保全の為の手段、新製品開発　事務方、デザインレビュー、試作品から量産品制作までの進捗管理（PDCAサイクル）、内部監査対応（被監査部門）、監査部門との交渉、被監査部門からの対応項目内容確認\n平たく言うと、何でも屋でした。開発設計事務方、財務、人事、製造、輸出、品質、製造業の業務ほぼ全てに関われたので、それぞれの仕事の目的、気をつける、難しい等学ぶ事ができました。\n現職の職業紹介にいかせています。", imageUrl: "https://altosaex.sakura.ne.jp/jobimg/man.png", sessionVideo: "ON", preferredSessionTime: "都度相談" },
	{ id: 25, status: "現職", job: "会社員", industry: "家電", yearsOfExperience: 4, nickname: "K", age: "30代", gender: "女性", comment: "グローバル家電メーカーにて、アジア太平洋地域の市場調査責任者をしています。", imageUrl: "https://altosaex.sakura.ne.jp/jobimg/woman.png", sessionVideo: "OFF", preferredSessionTime: "都度相談" },
	{ id: 26, status: "現職", job: "看護師", industry: "医療", yearsOfExperience: 16, nickname: "しま", age: "39歳", gender: "女性", comment: "大学病院で看護師をしています。不定期な休みで夜勤もありますが楽しく働いています。", imageUrl: "https://altosaex.sakura.ne.jp/jobimg/shima.png", sessionVideo: "ON", preferredSessionTime: "都度相談" },
	{ id: 27, status: "前職", job: "保育士", industry: "保育", yearsOfExperience: 6, nickname: "カナエ", age: "38歳", gender: "女性", comment: "・正規職員/パート共に経験あり\n・支援センターでの在籍1年\n現在は保育職から離れていますが、仕事内容、保護者との関わりについて等お伝えできます。\nまた現役保育士の友人がたくさんいるので生の声もお伝えすることが可能です。", imageUrl: "https://altosaex.sakura.ne.jp/jobimg/woman.png", sessionVideo: "ON", preferredSessionTime: "都度相談" },
]
